...
public class frmModVuelo extends javax.swing.JFrame {
                ...
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                .addGap(38, 38, 38)
                                                .addComponent(jPanel3, javax.swing.GroupLayout.PREFERRED_SIZE, 361,
        ...
        jPanel1Layout.setVerticalGroup(
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(jLabel1)
                                .addGap(18, 18, 18)
                                .addComponent(jPanel3, javax.swing.GroupLayout.PREFERRED_SIZE, 206,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
    ...
    private void txtIdVueloKeyTyped(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_txtIdVueloKeyTyped
        ...
        if (!Character.isDigit(c) || id.length() >= 10)
            evt.consume();
        if (txtIdVuelo.getText().length() >= 4)
            evt.consume();
    ...
    private void txtAerolineaKeyTyped(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_txtAerolineaKeyTyped
        ...
        if (!Character.isLetter(c) && c != KeyEvent.VK_SPACE)
            evt.consume();
        if (txtAerolinea.getText().length() >= 50)
            evt.consume();
    ...
    private void txtOrigenKeyTyped(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_txtOrigenKeyTyped
        ...
        if (txtOrigen.getText().length() >= 60)
            evt.consume();
    ...
    private void txtDestinoKeyTyped(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_txtDestinoKeyTyped
        ...
        if (!Character.isDigit(c) || telefono.length() >= 12)
            evt.consume();
        if (txtDestino.getText().length() >= 12)
            evt.consume();
    ...
    private void txtEscalaKeyTyped(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_txtEscalaKeyTyped
        ...
        if (!Character.isLetter(c) || telefono.length() >= 2)
            evt.consume();
        if (txtEscala.getText().length() >= 2)
            evt.consume();
